...
import eFlow from "./eFlow.png"
import UCIEats from "./UCIEats.png"
                ...
                <div className="col-auto">
                  <div id="portfolioContent">
                    ...
                    <div className="row">
                      <div className="col-6">
                        <div className="card" >
                          <a href="https://cprom.github.io/running-wild/"><img className="card-img-top" src={UCIEats} alt="UCI Eats" height="200px" width="200px" /></a>
                      ...
                      <div className="col-6">
                        <div className="card" >
                          <img className="card-img-top" src={eFlow} alt="eFlow" height="200px"
                            width="200px" />
                          <div className="card-body">
                ...
                <div className="col-auto">
                  <div id="portfolioContent">
                    <div className="row">
                      <div className="col-6">
                        <div className="card" >
                          <a href="https://cprom.github.io/running-wild/"><img className="card-img-top" src={UCIEats}
                    ...
                    <div className="row">
                      <div className="col-6">
                        <div className="card" >
                          <img className="card-img-top" src={eFlow} alt="eFlow" height="200px" width="200px" />
                          <div className="card-body">
